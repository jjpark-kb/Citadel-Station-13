...
#define CHILDREN_ATOM	(1<<12)

#define F13GRANDCONFESSOR	(1<<0)
#define F13CONFESSOR		(1<<1)
#define F13SEER				(1<<2)
#define F13INQUISITOR		(1<<3)
#define F13GRANDZEALOT		(1<<4)
#define F13ZEALOT			(1<<5)
#define F13CHILDATOM		(1<<6)
...
#define JOB_DISPLAY_ORDER_GRANDCONFESSOR	107
#define JOB_DISPLAY_ORDER_CONFESSOR			108
#define JOB_DISPLAY_ORDER_SEER				109
#define JOB_DISPLAY_ORDER_INQUISITOR		110
#define JOB_DISPLAY_ORDER_GRANDZEALOT		111
#define JOB_DISPLAY_ORDER_ZEALOT			112
#define JOB_DISPLAY_ORDER_CHILDATOM			113
